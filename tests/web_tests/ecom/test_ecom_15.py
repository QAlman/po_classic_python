...
class TestEcom_15(WebBase):
    ...
    def test_ecom_15(self):
        ...
        ecom.open_page_all(engine.WEB.ecom.ecom_test.Locator.ecom_url_15)
        ecom.click_favorites_small()
        ecom.click_favorites_small()
        ecom.click_favorites_small()
        ecom.basket_add_small()
        ecom.open_page_all(engine.WEB.ecom.ecom_test.Locator.ecom_url_15_1)
        ecom.click_favorites_remove()
        ecom.add_basket()
        ecom.open_page_all(engine.WEB.ecom.ecom_test.Locator.ecom_url_15_2)
        v = "Список"
